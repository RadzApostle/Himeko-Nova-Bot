...
`.trim())
    ...
    // Auto-create receiver so transfer always works
    if (!receiverData) {
        global.db.data.users[who] = { money: 0, limit: 100, exp: 0, level: 0, bank: 0, registered: false, premium: false, premiumTime: 0 }
        receiverData = global.db.data.users[who]
        console.log(`[DB] User auto-created via transfer: ${who}`)
    }
